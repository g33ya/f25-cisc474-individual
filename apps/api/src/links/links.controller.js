...
let LinksController = (() => {
    let _classDecorators = [Controller('links')];
    ...
    var LinksController = class {
        ...
        static {
            ...
            LinksController = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        linksService = __runInitializers(this, _instanceExtraInitializers);
    ...
    return LinksController = _classThis;
})();
